...
function Category(valorTitle){	
    ...
    //Implementación personal. Para controlar todos los productos en una tienda tanto por su id como por su categoría, creamos un array en 'Shop' con los productos que se encuentren en dicha tienda, y aparte, otro array en 'Category' para clasificarlos de ambas formas.
    var products=[];
